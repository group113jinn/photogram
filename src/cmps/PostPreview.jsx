...
export function PostPreview({ post, showModal}) {
  ...
  return (
    <ul className="post-preiew-card">
      ...
      <ul className="shortcuts-bar">
        <li>
          <ul>
            <li>{isCurrUserLiked ? unlikedIcon : likedIcon}</li>
      ...
      <ul className="post-description">
        <li>
  <span> {post.reactions.length}{post.reactions.length > 1 ? " likes" : " like"}</span>
        </li>
        <li>
