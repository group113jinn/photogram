...
function _PostPreview({ post, showModal, onLikePost, onCommentInput, onSaveComment, onToggleComments, loggedInUser }) {
  const currUser = () => loggedInUser.username
  ...
  const isCurrUserLiked = post.reactions.some(reaction => reaction.by.username === currUser) //change to a current logged in user
