...
export function Header({onSetFilter}) {
    ...
    return (
        <section className="main-header">
            ...
            <ul>
                ...
                <li profile_photo={profile_photo}><Link  to="/user/profile"><img src={profile_photo} className="navbar-profile-pic" alt="user profile" /></Link></li>
            </ul>
        </section >
